class Model {
    constructor() {
        this.version = '4.0.0';
        this.package = 'com.armanco.integral_persian';
        this.homepage = 'http://arman.co.com/';
        this.api = 'http://arman.co.com/api/applist_formula.php';
        this.addId = 'ca-app-pub-4301546764905932/7670860860';
        this.title = 'انتگرال';
        this.subTitle = 'جدول انتگرال';
        this.description = 'این برنامه شامل جدول کامل انتگرال ها می باشد.';
        this.page = 1;
        this.category = 0;

        this.categoriesTitles = ['گویا', 'نمایی', 'لگاریتمی', 'مثلثاتی', 'معکوس مثلثاتی', 'هذلولوی', 'هذلولوی معکوس', 'مشتق دوم', 'قدر مطلق', 'مخصوص', 'انتگرال‌های معین'];
...
class Controller {
    ...
    init() {
        window.addEventListener("load", () => {
            ...
            this.addMenuItemMute('menua', 'apps', 'برنامه های مشابه', 3);
            this.addMenuItemMute('menui', 'info', 'درباره برنامه', 4);
